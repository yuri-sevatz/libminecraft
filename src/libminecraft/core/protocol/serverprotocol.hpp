...
#ifndef LIBMINECRAFT_SERVERPROTOCOL_HPP
#define LIBMINECRAFT_SERVERPROTOCOL_HPP
...
namespace libminecraft
{
    ...
    {
    public:
        ServerProtocol(std::iostream &stream);

        // Returns a reference to the next client packet read from a client.
        // This memory is not freed.
        ClientPkt * const Read();

        // Write data from the server.
        void Write(ServerPkt & packet);
    };
}

#endif // LIBMINECRAFT_SERVERPROTOCOL_HPP
