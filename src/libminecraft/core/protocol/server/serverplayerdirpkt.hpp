...
#ifndef LIBMINECRAFT_SERVERPLAYERDIRPKT_HPP
#define LIBMINECRAFT_SERVERPLAYERDIRPKT_HPP
...
{
    class ServerPlayerDirPkt : public ServerPkt
    {
    public:
...
#endif // LIBMINECRAFT_SERVERPLAYERDIRPKT_HPP
