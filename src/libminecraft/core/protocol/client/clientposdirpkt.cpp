...
{
    const MinecraftTypes::Byte ClientPosDirPkt::id = ClientPosDirPkt::POSDIR;

    ClientPosDirPkt::ClientPosDirPkt() :
            ClientPkt(ClientPkt::IDENT)
    {

    }

    void ClientPosDirPkt::read(std::istream &stream)
    {
    ...
    void ClientPosDirPkt::write(std::ostream &stream) const
    {
        MinecraftStream::putByte(stream, ClientPosDirPkt::id); // Byte (packet id)
    ...
    void ClientPosDirPkt::toReadable(std::ostream &os) const
    {
