...
#ifndef LIBMINECRAFT_CLIENTSETBLOCKPKT_HPP
#define LIBMINECRAFT_CLIENTSETBLOCKPKT_HPP
...
{
    class ClientSetBlockPkt : public ClientPkt
    {
    public:
...
#endif // LIBMINECRAFT_CLIENTSETBLOCKPKT_HPP
