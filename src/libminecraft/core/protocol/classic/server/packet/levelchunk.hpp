...
#ifndef LIBMINECRAFT_CLASSIC_SERVER_PACKET_LEVELCHUNK_HPP
#define LIBMINECRAFT_CLASSIC_SERVER_PACKET_LEVELCHUNK_HPP
...
#endif // LIBMINECRAFT_CLASSIC_SERVER_LEVELCHUNKPKT_HPP
